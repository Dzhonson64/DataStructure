...
public:
	...
	queue<Vertex*> * pendingVertexes;				// очередь вершин дл€ дальнейшего их рассмотрени€
	list<Vertex*> * vertexes;						// список всех вершин
	list<Edge> * edges;								// список рЄбер
	...
	list<Vertex*>* getVertexList(Vertex & vertex);	// получение списка смежности дл€ вершины vertex
};
